...
import ScapeTeaBot.modules.helper_funcs.git_api as api
import ScapeTeaBot.modules.sql.github_sql as sql

from ScapeTeaBot import dispatcher, OWNER_ID, EVENT_LOGS, DRAGONS, DEMONS
