...
import ScapeTeaBot.modules.sql.notes_sql as sql
from ScapeTeaBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from ScapeTeaBot.__main__ import DATA_IMPORT
from ScapeTeaBot.modules.helper_funcs.chat_status import user_admin
from ScapeTeaBot.modules.helper_funcs.alternate import typing_action

# from ScapeTeaBot.modules.rules import get_rules
import ScapeTeaBot.modules.sql.rules_sql as rulessql

# from ScapeTeaBot.modules.sql import warns_sql as warnssql
import ScapeTeaBot.modules.sql.blacklist_sql as blacklistsql
from ScapeTeaBot.modules.sql import disable_sql as disabledsql

# from ScapeTeaBot.modules.sql import cust_filters_sql as filtersql
# import ScapeTeaBot.modules.sql.welcome_sql as welcsql
import ScapeTeaBot.modules.sql.locks_sql as locksql
from ScapeTeaBot.modules.connection import connected
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @ScapeTeaBotSupport"
            )
...
def export_data(update, context):
    ...
    f = open("ScapeTeaBot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ScapeTeaBot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `ScapeTeaBot-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("ScapeTeaBot{}.backup".format(chat_id))  # Cleaning file
