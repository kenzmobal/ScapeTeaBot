...
import ScapeTeaBot.modules.sql.global_bans_sql as gban_sql
import ScapeTeaBot.modules.sql.users_sql as user_sql
from ScapeTeaBot import DEV_USERS, OWNER_ID, dispatcher
