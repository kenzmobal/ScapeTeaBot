...
import ScapeTeaBot.modules.sql.connection_sql as sql
from ScapeTeaBot import dispatcher, DRAGONS, DEV_USERS
from ScapeTeaBot.modules.helper_funcs import chat_status
