...
from ScapeTeaBot import (DEV_USERS, OWNER_ID, DRAGONS, SUPPORT_CHAT, DEMONS,
                          WOLVES, dispatcher)
from ScapeTeaBot.modules.helper_funcs.chat_status import (dev_plus, sudo_plus,
                                                           whitelist_plus)
...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(),
                                   'ScapeTeaBot/elevated_users.json')
