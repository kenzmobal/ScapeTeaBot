...
import telegram
from ScapeTeaBot import WOLVES, dispatcher
from ScapeTeaBot.modules.disable import DisableAbleCommandHandler
from ScapeTeaBot.modules.helper_funcs.chat_status import (bot_admin,
                                                           can_restrict,
                                                           is_user_admin,
                                                           user_admin,
                                                           user_admin_no_reply)
...
from ScapeTeaBot.modules.helper_funcs.string_handling import split_quotes
from ScapeTeaBot.modules.log_channel import loggable
from ScapeTeaBot.modules.sql import warns_sql as sql
...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # ScapeTeaBot's sticker
        keyboard = None
