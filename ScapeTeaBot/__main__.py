...
from ScapeTeaBot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          SUPPORT_CHAT, dispatcher, StartTime, telethn, updater)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from ScapeTeaBot.modules import ALL_MODULES
from ScapeTeaBot.modules.helper_funcs.chat_status import is_user_admin
from ScapeTeaBot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ScapeTeaBot.modules." +
                                              module_name)
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="Add ScapeTeaBot to your group",
                     ...
                     [
                         InlineKeyboardButton(
                             text="Support Group",
                             url=f"https://t.me/ScapeTeaBotSupport"),
                     ],
                     [
                         InlineKeyboardButton(
                     ...
                     [
                         InlineKeyboardButton(
                             text="Source code",
                             url="https://github.com/Calliope-K/ScapeTeaBot")
                     ]]))
    else:
